...
ratite_stats = read.csv("../../data/phyloacc-aln-stats-ratite-2000.csv", header=T)
...
var_dists = plot_grid(sim_var_dist, msc_sim_var_dist, ratite_var_dist, ncol=3, labels=c("500 simulated loci", "200 MSC simulated loci", "2000 ratite loci"), label_size=8)
print(var_dists)
...
inf_dists = plot_grid(sim_inf_dist, msc_sim_inf_dist, ratite_inf_dist, ncol=3, labels=c("500 simulated loci", "200 MSC simulated loci", "2000 ratite loci"), label_size=8)
print(inf_dists)
...
var_inf_cors = plot_grid(sim_var_inf_cor, msc_sim_var_inf_cor, ratite_var_inf_cor, ncol=3, labels=c("500 simulated loci", "200 MSC simulated loci", "2000 ratite loci"), label_size=8)
print(var_inf_cors)
...
scf_dists = plot_grid(sim_scf_dist, msc_sim_scf_dist, ratite_scf_dist, ncol=3, labels=c("500 simulated loci", "200 MSC simulated loci", "2000 ratite loci"), label_size=8)
print(scf_dists)
...
inf_scf_cors = plot_grid(sim_inf_scf_cor, msc_sim_inf_scf_cor, ratite_inf_scf_cor, ncol=3, labels=c("500 simulated loci", "200 MSC simulated loci", "2000 ratite loci"), label_size=8)
print(inf_scf_cors)
